...
> **Warning**:
> Make sure to backup of all important files in a separate
> location like on a flash drive or in OneDrive before proceeding any
> further. Using a UNIX Terminal can change your
...
> **Note**: You can add ``Terminal`` to your ``Dock`` for faster access in future projects.
