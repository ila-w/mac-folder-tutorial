...
1) Open Terminal
2) 
3) Change to the new folder's directory location
4) Generate the icon file
5) Attach the icon to the folder
6) Hide the icon file
7) Remove unecessary files
8)  Remove the custom icon from the folder
